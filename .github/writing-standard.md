...
- Keep the wrap width of the file. A file wraps near 100 columns. The files in
  `lxr-codegen/src/regex/` and `lxr-codegen/src/compiler/` wrap near 80
  columns, thus keep 80 in those two directories.
